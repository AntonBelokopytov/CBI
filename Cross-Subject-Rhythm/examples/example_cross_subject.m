...
Wsize = 2.0;    % Размер окна, с (увеличено для более стабильной оценки ковариаций)
Ssize = 0.5;    % Шаг окна, с (увеличено для баланса перекрытия)
N_neigb = 7;    % Количество ближайших соседей (k) (7 часто оптимально для Self-Tuning графа)
